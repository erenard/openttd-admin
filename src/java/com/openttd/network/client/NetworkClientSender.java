...
public class NetworkClientSender extends NetworkSender {
    ...
    /**
     * Send chat as the server: uint8 Action such as NETWORK_ACTION_CHAT_CLIENT
     * (see #NetworkAction). uint8 Destination type such as DESTTYPE_BROADCAST
     * (see #DestType). uint32 ID of the destination such as company or client
     * id. string Message.
     */
