...
public class Company implements Cloneable {
    ...
    protected Object clone() throws CloneNotSupportedException {
        ...
        if (lastValue != null) {
            clone.setLastValue(new BigInteger(lastValue.toString()));
        }
        if (loan != null) {
            clone.setLoan(new BigInteger(loan.toString()));
        }
        ...
        if (previousValue != null) {
            clone.setPreviousValue(new BigInteger(previousValue.toString()));
        }
        if (shareOwners != null) {
            clone.setShareOwners(shareOwners.clone());
        }
        if (stations != null) {
            clone.setStations(stations.clone());
        }
        clone.setUsePassword(usePassword);
        if (vehicules != null) {
            clone.setVehicules(vehicules.clone());
        }
        return clone;
    }
